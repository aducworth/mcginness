    ...
    <script type="text/javascript">
		$(document).ready(function(){
			...
			$('#hex_index-id').colorpicker();
			
			$('#product_type-id').change(function() {
				
				var postData = 'product_type=' + $(this).val();
				
				$.ajax({
				  url: '/get_subcategories?ajax=true',
				  data: postData,
				  type: "POST"
				}).done(function(data) {
					$('#product_subcategory-id').html( data );
				  //alert( data );
				});
