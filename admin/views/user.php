...
<p class='action-buttons'>
	...
	<? if( $_GET['id'] ): ?>
		...
		<button id='delete-user' class="btn btn-danger pull-left delete-item">Delete</button>
        
    <? else: ?>
    
    	<button id='cancel-user' class="btn btn-danger pull-left cancel-item">Cancel</button>
