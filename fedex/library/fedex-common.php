...
function getProperty($var){
	...
	if($var == 'accounttovalidate') Return '510087720';
	if($var == 'meter') Return '118583421';
	if($var == 'key') Return 'IHnZfmVguyAANnyQ';
	if($var == 'password') Return 'QzcAnFLmrjT0UNyQcqo9Rp7LU';
