<?
	...
	if( is_array( $_POST['option'] ) ) {
		...
		foreach( $_POST['option'] as $o ) {
			...
			$price = $store->calculatePrice( $o, $_POST['width'], $_POST['height'], $_POST['depth'], $_POST['length'], $_POST['product_price'], $_POST['profile_price'], $_POST['wood_price'], $_POST['stain_price'] );
